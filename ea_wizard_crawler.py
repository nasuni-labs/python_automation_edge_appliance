    ...
    while True:
        ...
        try:
            ...
            if "login/?next=/" in page.url:
                logging.warning("Not logged in. Attempting to log in.")
...
class EdgeAppliance:
    ...
    def get_state_from_nmc(self):
        ...
        try: 
            ...
            logging.error("Error occurred while fetching API data: %s", e)
        return 0
    ...
    def get_ad_config(self):
        ...
        while True:
            ...
            a = join_ad_wheel(self.page, self.mach_name, self.vars_dict)
            if a['success'] == False:
